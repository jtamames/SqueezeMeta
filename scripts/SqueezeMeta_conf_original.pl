...
$rpkmfile="$resultpath/10.$projectname.rpkm";       #-- From mapbamsamples.pl, rpkm counts for all samples
$mapcountfile="$resultpath/10.$projectname.mapcount";	#-- From mapsamples.pl, rpkm and coverage counts for all samples
$coveragefile="$resultpath/10.$projectname.coverage";   #-- From mapbamsamples.pl, rpkm counts for all samples
$contigcov="$resultpath/10.$projectname.contigcov";     #-- From mapbamsamples.pl, coverages of  for all samples
