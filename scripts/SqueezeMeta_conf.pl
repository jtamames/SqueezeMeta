...
$gff_file_blastx="$resultpath/08.$projectname.merged.gff";            #-- gff file from prodigal & blastx
$fun3tax_blastx="$resultpath/08.$projectname.fun3.tax.merged";	#-- Fun3 annotations prodigal & blastx, KEGG
$fun3kegg_blastx="$resultpath/08.$projectname.fun3.kegg.merged";	#-- Fun3 annotations prodigal & blastx, KEGG
$fun3cog_blastx="$resultpath/08.$projectname.fun3.cog.merged";	#-- Fun3 annotation prodigal & blastx, COGs
$fna_blastx="$resultpath/08.$projectname.blastx.fna";	#-- Secuencias nt obtenidas por blastx
$allorfs="$resultpath/09.$projectname.allorfs";         #-- From summary_contigs.pl, allorfs file
$alllog="$resultpath/09.$projectname.contiglog";	#-- From summary_contigs.pl, contiglog file (formerly alllog file)
$rpkmfile="$resultpath/10.$projectname.rpkm";       	#-- From mapsamples.pl, rpkm counts for all samples
$mapcountfile="$resultpath/10.$projectname.mapcount";	#-- From mapsamples.pl, rpkm and coverage counts for all samples
$coveragefile="$resultpath/10.$projectname.coverage";   #-- From mapsamples.pl, rpkm counts for all samples
$contigcov="$resultpath/10.$projectname.contigcov";     #-- From mapsamples.pl, coverages of  for all samples
