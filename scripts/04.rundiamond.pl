...
our($aafile,$databasepath,$numthreads,$diamond_soft,$nodiamond,$nocog,$nokegg,$interdir,$tempdir,$newtaxdb,$cog_db,$kegg_db,$nr_db,$blocksize,$evaluetax4,$minidentax4,$evaluefun4,$minidenfun4,$cogdiamond,$keggdiamond,$taxdiamond,$fastnr,$opt_db,$resultpath,$methodsfile,$syslogfile);
my $command;
...
if(!$notax) {
	$command =  "$diamond_soft $blastmode -q $aafile -p $numthreads -d $nr_db -e $evaluetax4 --id $minidentax4 -f tab -b $blocksize -g 100 -o $taxdiamond";
