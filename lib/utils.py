...
def parse_tax_table(tax_table):
    ...
    Return:
        ...
        orf_tax_wranks: same, but with prefixes indicating each taxonomi rank (eg "p_<phylum>")
    """
    orf_tax = {}
    orf_tax_wranks = {}
...
def parse_contig_table(contig_table):
    ...
    Return
        ...
        contig_tax_wranks: same, but with prefixes indicating each taxonomi rank (eg "p_<phylum>")
    """
    contig_tax = {}
    contig_tax_wranks = {}
    contig_abunds = {}
