...
###############################################################################
 ...
 #      are released in the public domain
 #
 #  File 'README.licenses' in the bin/canu directory of this distribution contains
 #  full conditions and disclaimers for each license.
 #
 #  This file was further modified from the one included in Canu v1.8
 #   (https://github.com/marbl/canu/releases/download/v1.8/)
 #   by Fernando Puente-Sánchez in 2018-NOV-13. The modified version is
