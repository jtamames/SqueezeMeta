...
This function selects the most abundant taxa across all samples in a SQM
object and represents their abundances in a barplot. Alternatively, a
custom set of taxa can be represented.
...
|                                | ``phylum``).                        |
+--------------------------------+-------------------------------------+
| ``count``                      | character. Either ``"percent"`` for |
|                                | percentages, or ``"abund"`` for raw |
|                                | abundances (default ``"percent"``). |
+--------------------------------+-------------------------------------+
...
|                                | taxonomy otherwise),                |
|                                | ``"bins_gtdb"`` (GTDB bin taxonomy) |
|                                | or ``"bins_sqm"`` (SQM bin          |
|                                | taxonomy) (default: use the         |
...
|                                | least abundant taxa, and include    |
...
|                                | contain fully classified contigs    |
|                                | (default ``FALSE``).                |
+--------------------------------+-------------------------------------+
