...
This function selects the most abundant functions across all samples in
a SQM object and represents their abundances in a heatmap.
...
+----------------------------+-----------------------------------------+
| ``fun``                    | character. Custom functions to plot. If |
...
+----------------------------+-----------------------------------------+
| ``gradient_col``           | A vector of two colors representing the |
|                            | low and high ends of the color gradient |
|                            | (default                                |
...
|                            | number of reads in the original project |
|                            | (default ``FALSE``).                    |
+----------------------------+-----------------------------------------+
